...
function(){
    if(document.visibilityState === "visible"){
        document.title = "Portfolio |   Ajit Roy";
        $("#favicon").attr("href","./assests/images/Profile Pic-fotor-bg-remover-2023051113812.png");
    }
    else {
...
// <!-- typed js effect starts -->
    var typed = new Typed(".typing-text", {
        strings: ["Full Stack Web development", "Java Backend Development"],
        loop : true,
        typeSpeed: 50,
		backSpeed: 30,
		backDelay: 500,
...
/* SCROLL PROJECTS */
srtop.reveal('.project',{interval: 200}); 
